...
const EditHealthVitalsScreen: React.FC<Props> = ({ navigation }) => {
  ...
  useEffect(() => {
    const fetchHealthVitals = async () => {
      ...
      try {
        ...
        const response = await axios.get(`${API_BASE_URL}/healthvitals/${storedUsername}`);
  ...
  const saveDetails = async () => {
    ...
    try {
      ...
      // *** IMPORTANT: Replace with your actual API endpoint ***
      const response = await axios.post(`${API_BASE_URL}/healthvitals/${storedUsername}`, payload);
